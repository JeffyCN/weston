...
weston - program to do something

# SYNOPSIS

**weston** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**weston** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **weston** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**weston** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    weston. See **foo.conf**(5) for further details.
...
**weston** provides some return codes, that can be used in scripts:
